...
export const modelArchs: ModelArch[] = [
  ...
  },
  {
    ...
    defaults: {
      ...
      'config.process[0].datasets[x].max_frames': [41, 1],
      'config.process[0].sample.fps': [16, 1],
      'config.process[0].datasets[x].fps': [16, 1],
    },
    disableSections: ['network.conv'],
    additionalSections: ['datasets.max_frames', 'datasets.fps', 'model.low_vram'],
  },
  {
    ...
    disableSections: ['network.conv'],
    additionalSections: ['sample.ctrl_img', 'datasets.max_frames', 'datasets.fps', 'model.low_vram'],
  },
  {
    name: 'wan21_i2v:14b',
  ...
  },
  {
    ...
    defaults: {
      ...
      'config.process[0].datasets[x].max_frames': [121, 1],
      'config.process[0].sample.fps': [24, 1],
      'config.process[0].datasets[x].fps': [24, 1],
    ...
    disableSections: ['network.conv'],
    additionalSections: ['sample.ctrl_img', 'datasets.max_frames', 'datasets.fps', 'model.low_vram', 'datasets.do_i2v'],
  },
  {
    name: 'lumina2',
    label: 'Lumina2',
